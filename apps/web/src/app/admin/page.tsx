      ...
      <div className="mb-10 space-y-6">
        ...
        <AdminNavSection
          ...
          items={[
            ...
            { href: "/admin/content-marketing", label: "콘텐츠 마케팅", desc: "블로그·유튜브 캐던스 (W33)" },
            { href: "/admin/press", label: "언론·발표", desc: "PR 추적 (W33)" },
            { href: "/brand-kit", label: "Brand Kit", desc: "로고·컬러·타이포 가이드 (W33)" },
            { href: "/admin/certificates", label: "수료증 발급", desc: "이메일 자동 발송 (v2.1)" },
            { href: "/admin/email-log", label: "이메일 로그", desc: "Resend 발송 추적 (v2.1)" },
            { href: "/pricing", label: "요금제 페이지", desc: "Stripe 결제 (v2.1)" },
