...
export async function GET(_request: NextRequest) {
  ...
  const checks: { name: string; migration: string; table: string; column?: string }[] = [
    ...
    { name: "blog_posts (W33)", migration: "0046", table: "blog_posts", column: "slug" },
    { name: "content_pieces (W33)", migration: "0046", table: "content_pieces", column: "channel" },
    { name: "press_mentions (W33)", migration: "0046", table: "press_mentions", column: "mention_type" },
    { name: "global_markets (W35)", migration: "0047", table: "global_markets", column: "country_code" },
    ...
    { name: "email_log (v2.1)", migration: "0050", table: "email_log", column: "status" },
    { name: "subscriptions (v2.1)", migration: "0050", table: "subscriptions", column: "plan" },
    { name: "payment_log (v2.1)", migration: "0050", table: "payment_log", column: "status" },
    { name: "certificates (v2.1)", migration: "0050", table: "certificates", column: "certificate_number" },
  ];
